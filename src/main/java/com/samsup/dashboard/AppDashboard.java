...
import com.samsup.user.Reseller;
	...
	public void dashboardPage() {
		...
		while (!exitMenu) {
			...
			try {
				...
				case "1":
					try {
						User customer = userLogin.login(UserType.CUSTOMER);
						...
						User customer = userLogin.registerUser(UserType.CUSTOMER);
						appSession.setLoggedInUser(customer);
				...
				case "2":
					User newCustomer = userLogin.registerUser(UserType.CUSTOMER);
				...
				case "3":
					try {
						User resellerUser = reseller.login(UserType.RESELLER);
						...
						User resellerUser = reseller.registerUser(UserType.RESELLER);
						appSession.setLoggedInUser(resellerUser);
				...
				case "4":
					User newReseller = reseller.registerUser(UserType.RESELLER);
